import { BrumaIcon, GithubIcon } from '@/components/icons'
...
function Logo() {
  return (
    <Link href="/" className="flex items-center justify-start gap-2 text-brand-500" aria-label="Bruma logo">
      <BrumaIcon className="h-5 w-5 lg:h-6 lg:w-6" />
      <span className="text-xl lg:text-2xl">Bruma</span>
    </Link>
  )
}
